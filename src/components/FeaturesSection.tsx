...
const FeaturesSection = () => {
  ...
  return <div className="bg-white py-20 relative overflow-hidden font-inter">
      {/* Background image with enhanced styling */}
      <div className="absolute inset-0 z-0 bg-cover bg-center bg-fixed bg-no-repeat opacity-10" style={{
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          <span className="inline-block px-4 py-1.5 bg-[#6dd5fa]/20 text-[#2980b9] rounded-full text-sm font-medium mb-4">Features</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => <div key={index} className="opacity-0 transform translate-y-10" ref={el => featureRefs.current[index] = el}>
              <Card className="border-none shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 bg-white/80 backdrop-blur-sm group overflow-hidden">
